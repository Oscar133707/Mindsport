            ...
            <div className="flex flex-col space-y-4 md:space-y-6">
              {partners.map((partner) => (
                <a
                  ...
                  className="group flex items-center justify-center md:justify-start space-x-3 text-gray-300 md:hover:text-[#ffcb33] active:text-[#ffcb33] transition-all min-h-[44px] px-2"
                ...
                >
                  {partner.logo && (
                    <img 
                      src={partner.logo} 
                      alt={partner.logoAlt}
                      className="h-10 md:h-12 lg:h-16 w-auto object-contain opacity-80 md:group-hover:opacity-100 md:group-hover:scale-105 group-active:opacity-100 transition-all"
                    />
                  )}
                  <span className="font-medium text-base">{partner.name}</span>
                  <ExternalLink size={14} className="opacity-0 md:group-hover:opacity-100 transition-opacity hidden md:block" />
                </a>
              ))}
            </div>
          </div>
          ...
          <div className="space-y-4 md:space-y-6 text-center md:text-left">
            ...
            <div className="flex justify-center md:justify-start space-x-6">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 md:hover:text-pink-500 md:hover:scale-110 md:hover:bg-white/10 rounded-full active:text-pink-500 transition-all w-[44px] h-[44px] flex items-center justify-center"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 md:hover:text-[#0077b5] md:hover:scale-110 md:hover:bg-white/10 rounded-full active:text-[#ffcb33] transition-all w-[44px] h-[44px] flex items-center justify-center"
                aria-label="LinkedIn"
                style={{ WebkitTapHighlightColor: 'transparent' }}
              >
            ...
            <div className="text-sm md:text-base text-gray-400">
              <a href="mailto:info@mindsport.se" className="md:hover:text-[#ffcb33] md:hover:underline active:text-[#ffcb33] transition-colors min-h-[44px] flex items-center justify-center md:justify-start" style={{ WebkitTapHighlightColor: 'transparent' }}>
                info@mindsport.se
              </a>
            </div>
          </div>
